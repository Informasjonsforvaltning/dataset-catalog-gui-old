...
Se spesifikasjonen <a href='https://data.norge.no/specification/dcat-ap-no/#Datasett-spr%C3%A5k'>dct:language</a>`
  },
  Dataset_issued: {
  ...
  Dataset_modified: {
    ...
    description: "Se spesifikasjonen <a href='https://data.norge.no/specification/dcat-ap-no/#Datasett-endringsdato'>dct:modified</a>"
  },
  Dataset_publisher: {
...
Se spesifikasjonen <a href='https://data.norge.no/specification/dcat-ap-no/#Datasett-opphav'>dct:provenance</a>`
  },
  Dataset_conformsTo: {
    abstract:
      'Oppgi om datasettet er i henhold til gitt(e) standard(er), spesifikasjon(er) eller implementasjonsregler.',
    description: "Se spesifikasjonen <a href='https://data.norge.no/specification/dcat-ap-no/#Datasett-iSamsvarMed'>dct:conformsTo</a>"
  },
...
Se spesifikasjonen <a href='https://data.norge.no/specification/dcat-ap-no/#Datasett-frekvens'>dct:accrualPeriodicity</a>`
  },
...
Se spesifikasjonen <a href='https://data.norge.no/specification/dcat-ap-no/#Datasett-harKvalitetsnote'>dqv:hasQualityAnnotation</a>`
  },
  ...
  Dataset_hasQualityAnnotation_relevance: {
    ...
    description: "Se spesifikasjonen <a href='https://data.norge.no/specification/dcat-ap-no/#Datasett-harKvalitetsnote'>dqv:hasQualityAnnotation</a>"
  },
...
* F.eks. kan et kodeverk erstattet av en nyere utgave.`
  ...
  Dataset_relation: {
    ...
    description: `Lenke til veileder <a href='https://data.norge.no/guide/veileder-beskrivelse-av-datasett/#_kilde_datasett_avledet_fra'>her</a>`
  },
