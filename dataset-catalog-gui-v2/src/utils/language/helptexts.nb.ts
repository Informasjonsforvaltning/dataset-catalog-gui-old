export const helptextsNb = {
  Dataset_title: {
    abstract: 'Tittelen skal være kortfattet, kunne stå alene og gi mening. Forkortelser skal skrives helt ut.',
...
Se spesifikasjonen <a href='https://data.norge.no/specification/dcat-ap-no/#Datasett-beskrivelse' target='_blank'><span>Datasett: beskrivelse</span><i class="fa fa-external-link fdk-fa-right"></i></a>`,
  ...
  Dataset_spatial: {
    abstract: 'Søk etter geografisk område fra Administrative enheter (Kartverket) og velg fra nedtrekksliste.',
  ...
  Dataset_temporal: {
    abstract: 'Tidsrommet datasettet dekker dersom det kun har innhold fra visse perioder. ',
...
Her legger du inn de begrepene som brukes i datasettet. Begrepene brukes til å si noe om hva informasjonen i datasettet betyr. `,
  ...
  Dataset_keyword: {
    abstract: 'Sentralt innhold i datasettet som ennå ikke har begrepsdefinisjoner.',
...
`,
  ...
  Dataset_creator: {
    abstract: 'Brukes unntaksvis der det er datasett som er satt sammen av data som andre er ansvarlige for',
...
* Skaper vil ikke angis med organisasjonsnummer siden det typisk vil være en sammensatt gruppe.`,
  ...
  Dataset_contactPoint: {
    abstract: 'Angi kontaktinformasjonen som kan brukes ved henvendelser om et datasett.',
...
* Vcard https://www.w3.org/TR/vcard-rdf benyttes for å beskrive kontaktpunktet (se Kontaktpunkt)`,
  ...
  Dataset_documentation: {
    abstract: 'Referanse til en side som beskriver utdypende dokumentasjon om datasettet.',
  ...
  Dataset_accessRights: {
    abstract: 'Skal gjenspeile det mest begrensede feltet/opplysningen i datasettet.',
...
Se spesifikasjonen <a href='https://data.norge.no/specification/dcat-ap-no/#Datasett-tilgangsniv%C3%A5' target='_blank'><span>Datasett: tilgangsnivå</span><i class="fa fa-external-link fdk-fa-right"></i></a>`,
  ...
  Dataset_legalBasisForRestriction: {
    abstract: 'Angi referanse til relevant lov eller forskrift. Helst til lovdata på paragrafnivå.',
  ...
  Dataset_legalBasisForProcessing: {
    abstract: 'Angi referanse til relevant lov eller forskrift, samtykke eller nødvendighetsvurdering.',
...
Se spesifikasjonen <a href='https://data.norge.no/specification/dcat-ap-no/#Datasett-frekvens' target='_blank'><span>Datasett: frekvens</span><i class="fa fa-external-link fdk-fa-right"></i></a>`,
  ...
  Dataset_hasQualityAnnotation_accuracy: {
    abstract: 'Dersom datasettets innhold ikke er i samsvar med formålet, bør det oppgis her.',
...
Se spesifikasjonen <a href='https://data.norge.no/specification/dcat-ap-no/#Datasett-harKvalitetsnote' target='_blank'><span>Datasett: har kvalitetsnote</span><i class="fa fa-external-link fdk-fa-right"></i></a>`,
  ...
  Dataset_hasQualityAnnotation_completeness: {
    abstract: 'Dersom datasettet ikke innholder alle objekter som nevnt i formålet, bør det oppgis her.',
  ...
  Dataset_hasQualityAnnotation_availability: {
    abstract: 'Dersom datasettets tilgangsnivå har avvik eller tilleggsopplysninger, bør det oppgis her.',
  ...
  Dataset_hasQualityAnnotation_relevance: {
    abstract: 'Dersom det er bruksområder datasettet er spesielt egnet for eller ikke egnet for, bør det oppgis her.',
  ...
  Dataset_distribution: {
    abstract: 'For å angi hvor man kan få tilgang til datasettet skal det angis ulike distribusjoner.',
...
Se spesifikasjonen <a href='https://data.norge.no/specification/dcat-ap-no/#Datasett-type' target='_blank'><span>Datasett: type</span><i class="fa fa-external-link fdk-fa-right"></i></a>`,
  ...
  Dataset_source: {
    abstract: 'Peker til ressurs (datasett eller annet) som helt eller delvis er en kilde for det aktuelle datasettet.',
...
* Peker til datasett som er består av testdata til det aktuelle datasettet`,
  ...
  Dataset_requires: {
    abstract: 'Peker til en ressurs som må være tilstede for at datasettet skal kunne produseres.',
...
* F.eks. kan et kodeverk erstattet av en nyere utgave.`,
  ...
  Agent_type: {
    abstract: 'Enheter angis med organisasjonstype for å skille mellom offentlige og private datasetteiere.',
  ...
  Performance: {
    abstract: 'Oppgi responstiden til API-et. Typisk angitt i ms. Er det begrensinger på antall samtidige brukere?',
    description: '',
  },
  Availability: { abstract: 'Oppgi oppetiden til API-et.', description: '' },
  Cost: {
    abstract: 'Kostnader forbundet med å bruke API-et. Transaksjonskostnader, abonnement e.l.',
    description: '',
  },
  Distribution_description: {
    abstract: 'Ved flere enn én distribusjon bør forskjellene i innholdet beskrives.',
    description: '',
  },
  Distribution_type: {
...
Lenke til IANAs liste over offisielle medietyper: <a style="font-weight: bold;" target='_blank' href='http://www.iana.org/assignments/media-types/media-types.xhtml'>Media Types<i class="fa fa-external-link fdk-fa-right"/></a>`,
  ...
  Distribution_accessURL: {
    abstract: 'Lenke til selve distribusjonen eller til mer informasjon om hvordan man får tilgang.',
    description: '',
  },
...
* kan benyttes dersom alle data tilgjengelig via en tjeneste også er tilgjengelig for nedlasting som en fil.`,
  ...
  Distribution_landingpage: {
    abstract: 'Refererer til en nettside som gir tilgang til datasettet, distribusjoner og annen informasjon. ',
...
* bør peke til en side hos den originale tilbyderen av data.`,
  ...
  Distribution_documentation: {
    abstract: 'Lenke til informasjon som beskriver distribusjonens innhold og struktur.',
    description: '',
  },
  Distribution_issued: {
    abstract: 'Dato/tid når distribusjonen (f.eks. api) først ble publisert i tilknytning til et datasett.',
...
Datasett med tilgangsnivå "allmenn tilgang" og minst en distribusjon med åpen standardisens blir automatisk klassifisert som åpne data på data.norge.no.`,
  ...
  Catalog_title: {
    abstract: 'Kortfattet om katalogen. Angi, uten å liste, hvilke datasett den omfatter.',
...
* f.eks. datasettene til Brønnøysundregistrene.`,
  ...
  Catalog_dataset: {
    abstract: 'Beskriver datasettene i katalogen. Minst ett datasett er påkrevd.',
...
* Det offisielle navnet på virksomheten vil hentes fra Enhetsregisteret, men kortform (f.eks. Difi) kan legges inn av brukeren`,
  ...
  Related_dataset: {
    abstract: 'Legg til en eller flere datasettbeskrivelse(r) som er tilknyttet API-et.',
    description: '',
  },
  themesLos: {
