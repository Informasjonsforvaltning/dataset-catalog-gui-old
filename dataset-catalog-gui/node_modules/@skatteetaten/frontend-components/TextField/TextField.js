...
import { MaskedTextField, TextField as FabricTextField } from '@fluentui/react';
...
export const TextField = _ref => {
  ...
  return /*#__PURE__*/React.createElement("div", {
    id: mainId,
    className: classnames(getClassNames(_objectSpread({
      errorMessage
    }, rest)), className)
  }, /*#__PURE__*/React.createElement(LabelWithCallout, _extends({}, labelWithCalloutProps, {
    id: labelId,
    inputId: inputId,
    label: label,
    ...
    className: classnames(getClassNames(_objectSpread(_objectSpread({}, rest), {}, {
      editMode,
      readOnly
    })), className),
