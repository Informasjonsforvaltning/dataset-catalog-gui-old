...
export function getClassNames(props) {
  ...
  return mergeStyleSets({
    toggleButton: {
      ...
      fontSize: compact ? designtokenFonts['ske-font-size-s'] : designtokenFonts['ske-font-size-l'],
      ...
      selectors: {
        ...
        '& i': {
          ...
          fontSize: compact ? designtokenFonts['ske-font-size-icon-l'] : designtokenFonts['ske-font-size-icon-xl']
        }
      }
    },
    content: {
