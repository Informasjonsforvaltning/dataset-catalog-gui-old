...
export declare enum CardBorder {
...
export interface CardProps extends React.HTMLAttributes<HTMLDivElement> {
    ...
    color?: CardColor.BEIGE | CardColor.GREEN | CardColor.WHITE | CardColor.RED | CardColor.GREY;
    /** Ramme rundt kortet */
    border?: CardBorder.WHITE_BORDER | CardBorder.GREEN_BORDER | CardBorder.YELLOW_BORDER | CardBorder.RED_BORDER | CardBorder.GREY_BORDER;
