...
class Aside extends _Grid.Grid.Col {
  render() {
    return super.render();
  }
...
_defineProperty(Aside, "displayName", 'Aside');

_defineProperty(Aside, "propTypes", {
  ...
  xxlPush: _propTypes.default.number,
  xxxlPush: _propTypes.default.number,
  ...
  xxxlPull: _propTypes.default.number
});

_defineProperty(Aside, "defaultProps", {
  tag: 'aside',
  lg: 12,
  xl: 2
});