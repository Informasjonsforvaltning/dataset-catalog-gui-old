...
var _CheckBox = require("./CheckBox.classNames");
...
class CheckBox extends React.PureComponent {
  render() {
    ...
    return /*#__PURE__*/React.createElement(_react.Checkbox, _extends({}, props, {
      className: (0, _classnames.default)((0, _CheckBox.getClassNames)(this.props.error), className),
